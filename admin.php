...
$dataProducts = $ProductsModel->getAll();
  ...
  <main>
    ...
    <section class="container-table">
      <table>
        ...
        <tbody>
          <?php foreach ($dataProducts as $dataProducts) : ?>
            <tr>
              <td><?= $dataProducts->getName(); ?></td>
              <td><?= $dataProducts->getType(); ?></td>
              <td><?= $dataProducts->getDescription(); ?></td>
              <td><?= $dataProducts->getPriceFormated(); ?></td>
              <td><a class="botao-editar" href="editar-produto.php">Edit</a></td>
              <td>
                <form action="delete-product.php" method="post">
                <input name='id' value="<?= $dataProducts->getId();?>" hidden>
